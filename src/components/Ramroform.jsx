...
//     <div className = 'min-h-screen flex items-center justify-center bg-gray-100 p-4'> 
//          <div bg-white shadow-lg rounded-lg p-6 w-full max-w-md>
//         <h2 className = 'text-2xl font-bold mb-4 text-gray-800'> Subscribe to the NewsLetter</h2>
//         <form> 
//         <label className = 'block mb-2 font-medium text-gray-700'> Email Address
        
//           Email Address  </label>
        
        
//         <input type = "email" className = 'w-full px-4 py-2 border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 outline none'
